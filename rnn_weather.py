...
plt.legend()
plt.show()
dataset_graph.savefig('results/RNN_weather/dataset_graph.jpg', bbox_inches='tight')
...
model.save('assets/multivariate/rnn.tf', overwrite=True, include_optimizer=True)
...
plt.show()
fig.savefig('results/RNN_weather/final_output.jpg', bbox_inches='tight')
...
print('MAPE:', np.mean(np.abs((test_y[0].reshape((15,)) - predicted_values.reshape((15,))) / (test_y[0].reshape((15,))))) * 100,'\n')
