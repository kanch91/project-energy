...
# SARIMAX model
model = stats.tsa.statespace.SARIMAX(y_test[:327], order=[1, 1, 1],
...
y_pred = results.get_forecast(steps=37)

# Get confidence intervals of forecasts
pred_ci = y_pred.conf_int()

print(y_test[327:], y_pred.predicted_mean)
...
ax = y_test[327:].plot(label='Observed')
...
plt.show()
plt.savefig('results/SARIMAX_weather/final_output.jpg', bbox_inches='tight')
...
actual_test_result = y_test[327:] * 100000
